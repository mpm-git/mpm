...
<title>医疗行为管理系统－统计分析－医生查房统计</title>
        ...
        <li>
          <form>
            ...
            <select name="some_name2" id="some_name" style="width:90px;">
              <option value="option1">杨杰</option>
            </select>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            起始时间:
	           ...
	           <s:iterator value="#request.ActionReport">	           
	              ...
	              <% 
	               ...
	               <td>201</td>
	                   <%} %>  
	               <% 
	               String officeType = request.getAttribute("USEROFFICETYPE_CODE").toString();
	               if(officeType.equals("DOC")) {%> 
	               <td>主治医师</td>
	               <%} %>	                
	               <td>查房</td>  
