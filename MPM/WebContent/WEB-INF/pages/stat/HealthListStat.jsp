...
function delete_page(id){
	$.ajax({    
        url : '../stat/delete_healthpage.action',    
        type : 'post',    
        data : {
        	'id': id
        	},    
...
//跳转到修改页面
function updateJsp(id){
	window.location="../stat/to_update_health_page.action?id="+id;
/* 	$.ajax({    
  ...
  <div class="wrap">
    <div class="wrap">
      ...
      <div style="padding-top: 20px">
      	<div align="right"><a href="<s:url action="../stat/to_update_health_page.action" />"><img width="25px;" height="25px;" title="添加页面" src="<s:url value='/styles/image/add.png'/>"></a></div>
