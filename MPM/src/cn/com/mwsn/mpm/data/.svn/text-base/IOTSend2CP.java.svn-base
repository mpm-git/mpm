		...
		if(rfidPerson != null) {
			...
			if(rfidPerson.getRole().equals("1")) {
				...
				postfix = 
						...
						+ Constant.RFID_ID + "^" + tagID + "|"
						+ Constant.ID + "^" + IDGenerator.getUniqueID() + "|"
						+ Constant.CODE + "^" + nurse.getNurseId() + "|"
			...
			if(rfidPerson.getRole().equals("2")) {
				...
				postfix = 
						...
						+ Constant.CURWARD_CODE + "^" + patient.getCell().getInpatientArea().getName() + "|"
						+ Constant.CURWARD_DESC + "^" + patient.getCell().getInpatientArea().getDescc() + "|"
						+ Constant.CURROOM_CODE + "^" + patient.getCell().getCurroomCode() + "|"
						+ Constant.CURROOM_DESC + "^" + patient.getCell().getCurroomDesc() + "|"
